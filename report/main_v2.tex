...
This is by opposition to coalescent models where the model evolves from given point back to a previous state.
...
It answers the question: given a set of parameter distributions (called “\textbf{\glspl{prior}}”), what are the distributions (subsets of the \glspl{prior}), that give best results? This set of output distributions are then called “\textbf{\glspl{posterior}}”.
