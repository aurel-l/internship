...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw<2>[masseyGold, ultra thick, rounded corners] (0, 3.5) rectangle (5, 6.1);
    \draw<3>[masseyGold, ultra thick, rounded corners] (3.3, 2.5) rectangle (9.2, 6.2);
    \draw<4>[masseyGold, ultra thick, rounded corners] (5.5, 0) rectangle (9.2, 3.8);
    \draw<5>[masseyGold, ultra thick, rounded corners] (0, 0) rectangle (6.8, 3.2);
    \draw<6>;
  \end{tikzpicture}
\end{center}
\end{frame}
